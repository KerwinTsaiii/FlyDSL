...
| **RDNA3 / 3.5** | gfx110x / gfx1150 (Strix Point Radeon 890M), gfx1151 (Strix Halo), gfx1152 (Krackan), gfx1153 | 32 | WMMA (16x16x16) | F16/BF16/IU8/IU4 only — no FP8/FP4/scaled/sparse, no `ds_load_tr`/TDM/split-barriers, 64KB LDS/WG. Atom-based GEMM in `kernels/rdna3_f16_gemm.py`; raw-intrinsic GEMM in `kernels/rdna_f16_gemm.py` |
